import telebot
API_TOKEN = '5756205355:AAGWUcgsAC74ola3RCS7wuMubrCAxXKG598'
...
def echo_message(message):
    ...
    data={
        ...
        "tagets":[messa[7].split(":")[1],messa[8].split(":")[1],messa[9].split(":")[1],messa[10].split(":")[1],messa[11].split(":")[1],messa[12].split(":")[1],messa[13].split(":")[1]],
